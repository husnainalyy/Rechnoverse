            ...
            <footer class="bg-white dark:bg-gray-900">
                <div class="container px-6 py-12 mx-auto">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                        ...
                        <div>
                            <p class="font-semibold text-gray-800 dark:text-white">Our Initiatives</p>

                            <div class="flex flex-col items-start mt-5 space-y-2">
                                <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Renewable Energy</a>
                                <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Waste Reduction</a>
                                <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Eco-friendly Products</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <hr class="my-6 border-gray-200 md:my-8 dark:border-gray-700" />
                        ...
                        <div class=" flex items-center justify-between">
                            ...
                            <p className='text-2xl'>ECHOLEAF</p>
