    ...
    return (
        <div className='overflow-hidden'>
            ...
            <section className="h-full w-full   px-8 ">
                <div className="flex flex-col min-h-screen border-t-2">
                    <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
                        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                            <div className="text-black lg:w-1/2 lg:mx-6">
                                <h1 className="text-2xl font-semibold capitalize lg:text-3xl">Save the Earth</h1>

                                <p className="max-w-xl mt-6">
                                    Let's work together to save our planet. Every action counts! Whether it's reducing plastic use, conserving water, or supporting renewable energy, we can all make a difference.
                                </p>
